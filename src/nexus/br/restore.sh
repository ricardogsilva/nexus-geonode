...
# ##########################################################
# Run a restore
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./nexus/br/restore.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4nexus sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./nexus/br/restore.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING nexus RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./nexus/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED nexus RESTORE $(date)"
echo "-----------------------------------------------------"
