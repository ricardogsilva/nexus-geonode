...
RUN chmod +x /usr/src/nexus/tasks.py \
    && chmod +x /usr/src/nexus/entrypoint.sh
...
ENTRYPOINT service cron restart && service memcached restart && /usr/src/nexus/entrypoint.sh
